const CACHE='syndikat-v4-8';
const CORE=['./','./index.html','./style.css','./js/core.js','./cloud-config.js','./js/cloud.js','./assets/start-user.webp','./assets/start-noir.svg','./manifest.webmanifest','./icon.svg','./icon-192.svg','./icon-512.svg'];
