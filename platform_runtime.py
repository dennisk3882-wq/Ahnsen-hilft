...
def get_platform_snapshot() -> dict:
    ...
    return {
        ...
        "pwa_icon_192_url": _safe_url(settings.get("pwa_icon_192_url") or "/pwa/ahnsen-app-v6-192.png", "/pwa/ahnsen-app-v6-192.png"),
        "pwa_icon_512_url": _safe_url(settings.get("pwa_icon_512_url") or "/pwa/ahnsen-app-v6-512.png", "/pwa/ahnsen-app-v6-512.png"),
        "apple_touch_icon_url": _safe_url(settings.get("apple_touch_icon_url") or "/pwa/ahnsen-app-v6-180.png", "/pwa/ahnsen-app-v6-180.png"),
