'use strict';
(function(){
  const VERSION='3.2.0',baseStart=window.finanzplanV3Start,baseImport=window.handleImportFile,baseSettings=window.renderSettings;
