...
def warning_dashboard_page(active_warnings, recent_warnings, stats: dict, hinweis: str = "", fehler: str = "") -> HTMLResponse:
    ...
    html = f'''<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#174936"><title>Warnlage · Ahnsen hilft</title><style>{intern_nav_css()}
