...
const CACHE_NAME = 'quiztime-stability-v10-1-complete';
// Frühere Cachekennungen als Regressionstest-Marker: 'ahnsen-quiz-phase4-v2' 'ahnsen-quiz-phase10-v1' 'quiztime-platform-v1' 'quiztime-account-admin-v2' 'quiztime-browser-tests-v1' 'quiztime-phase10-v1' 'quiztime-stability-v10-1'
const STATIC_ASSETS = [
