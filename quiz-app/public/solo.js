...
function renderQuestion(currentState) {
  ...
  els.stage.innerHTML = `<div class="question-card solo-question-card">
    ...
    ${currentState.answered && question.explanation ? `<div class="solo-explanation answer-feedback success"><strong>💡 Kurz erklärt</strong><p>${escapeHtml(question.explanation)}</p></div>` : ''}
