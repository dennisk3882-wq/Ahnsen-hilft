...
const catalogs = [
  {
    ...
    expansions: [
      ...
      { prefix: 'adult-b3-', expected: 500, label: 'dritter Ausbau' },
    ],
  ...
  },
  {
    ...
    expansions: [
      ...
      { prefix: 'child-b3-', expected: 500, label: 'dritter Ausbau' },
    ],
...
const reportLines = [
  ...
  '## Automatisch geprüft',
  '',
  '- 2.000 Erwachsenenfragen und 2.000 Kinderfragen',
  '- erster, zweiter und dritter Ausbau enthalten jeweils exakt 500 neue Fragen je Zielgruppe',
  ...
  '- vollständiger Kinderkatalog: exakt 500 richtige Antworten je Position A, B, C und D',
