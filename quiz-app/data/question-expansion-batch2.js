...
const childSource = require('./question-expansion-batch2-child');
const adultSource = require('./question-expansion-batch2-adult');
...
validateBatch(childSource, {
  ...
  label: 'Kinder-Erweiterung 2',
});
validateBatch(adultSource, {
  expectedCount: 500,
  idPrefix: 'adult-b2-',
  categories: ADULT_CATEGORIES,
  label: 'Erwachsenen-Erweiterung 2',
});
